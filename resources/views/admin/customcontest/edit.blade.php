    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('match.customcontest', ['fantasy_type'=>base64_encode($collection->fantasyname),'matchkey'=>$collection->matchkey]) }}">
            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Edit Custom Contest</h4>
                    </div>
                    <!-- End Header -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="tom-select-custom">
                                        <select class="js-select form-select" id="matchkey" name="matchkey"
                                            ...
                                            @foreach ($launchedmatch as $val)
                                                <option <?php if ($collection->matchkey == $val->matchkey) {
                                                    echo 'selected';
                                                } ?> value="{{ $val->matchkey }}"
                                                    data-option-template='<span class="d-flex align-items-center"><span class="flex-grow-1 ms-2">{{ $val->name }}</span></span>'>
                                                    {{ $val->name }}</option>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="hidden" id="selectedCategory" value="{{$collection->contest_cat}}">
                                    <div class="tom-select-custom">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="teamsize" class="form-label">Team Size *<i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="team_size"></i></label>

                                    <input type="text" class="form-control" name="team_size id="team_size
                                        placeholder="" aria-label="" value="{{ $collection->team_size}}" required>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    function get_contest_category(value,selectedCategory) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                var select = $('#contest_cat');
                select.html('<option value="">Select Contest Category</option>');
                for (var i = 0; i < data.length; i++) {
                    select.append('<option value="' + data[i]['id'] + '">' + data[i]['name'] + '</option>');
                }

                // To set a selected option
                var selectedValue = selectedCategory; // Replace with the value you want to select
                select.val(selectedValue); // Set the selected value
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        get_contest_category(fantasy_type,selectedCategory);
    });
</script>
