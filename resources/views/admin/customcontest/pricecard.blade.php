                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <div class="row">
                                <input type="hidden" class="form-control" name="matchkey" id="matchkey"
                                        placeholder="" aria-label="" value="{{$collection->matchkey}}" required>
        ...
        swal({
            ...
            if (confirmed) {
                $.ajax({
                    ...
                    url: "{{ route('customcontest.custompricecarddelete') }}",
                    data: {
                        id: id
                    },
