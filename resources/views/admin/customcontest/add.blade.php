    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Contest ManagerManagerManagerManager</h1>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('match.customcontest', ['fantasy_type'=>base64_encode($fantasy_type),'matchkey'=>$_GET['matchkey']]) }}">
                        <i class="bi-eye"></i> View Custom Contest
                    </a>
                </div>
            </div>
            <!-- End Row -->
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="tom-select-custom">
                                        @foreach ($getfantasy as $val)
                                            @if ($fantasy_type == $val->name)
                                                <input type="hidden" value="{{ $val->id }}" name="fantasy_type">
                                            @endif
                                        @endforeach
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="fantasy_type" class="form-label">Match *<i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Fantasy Type"></i></label>
                                    <div class="tom-select-custom">
                                        <input type="hidden" value="{{ $_GET['matchkey'] }}" name="matchkey">
                                        <select class="js-select form-select" id="matchkey" name="matchkey"
                                            ...
                                            @foreach ($launchedmatch as $val)
                                                <option <?php if ($_GET['matchkey'] == $val->matchkey) {
                                                    echo 'selected';
                                                } ?> value="{{ $val->matchkey }}"
                                                    data-option-template='<span class="d-flex align-items-center"><span class="flex-grow-1 ms-2">{{ $val->name }}</span></span>'>
                                                    {{ $val->name }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="teamsize" class="form-label">Team Size *<i
                                            class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Team Size"></i></label>

                                    <input type="text" class="form-control" name="team_size" id="team_size"
                                        placeholder="Enter Team Size" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 maximum_user mb-4">
                                    ...
                                    <input type="number" class="form-control" name="maximum_user" id="maximum_user"
                                        placeholder="Enter Maximum Number" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row winning_percentage d-none">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="number" disabled class="form-control" name="winning_percentage"
                                        id="winning_percentage" placeholder="Enter Winning Percentage" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                ...
                                <div class="row multientry d-none">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="number" disabled class="form-control" name="team_limit"
                                            id="team_limit" placeholder="Enter Team Limit" aria-label="" value="11" required>
                                    </div>
                                </div>
                                <div class="row bonuspercentage d-none">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="bonus_percentage"
                                            id="bonus_percentage" placeholder="Enter Bonus Percentage" aria-label="" value="" required
                                            disabled>
                                    </div>
                                </div>
                            </div>
