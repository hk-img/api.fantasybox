            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Edit Series</h4>
                    </div>
                    <!-- End Header -->
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="js-flatpickr form-control flatpickr-custom"
                                        placeholder="Select Start Date" name="start_date" value="{{ $collection->start_date }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="js-flatpickr form-control flatpickr-custom"
                                        placeholder="Select End Date" name="end_date" value="{{ $collection->end_date }}"
                                        data-hs-flatpickr-options='{
                                              "dateFormat": "Y-m-d H:i",
                                              "enableTime": true,
                                              "minDate": "today"
