                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        @if ($item->launch_status == 'pending')
                                            <span class="d-block h5 text-inherit mb-0 text-warning">Pending</span>
                                        @else
                                            <span class="d-block h5 text-inherit mb-0 text-success">Launched</span>
                                        @endif
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        @if ($item->final_status == 'pending')
                                            <span class="d-block h5 text-inherit mb-0 text-warning">Pending</span>
                                        @elseif($item->final_status == 'IsReviewed')
                                            <span class="d-block h5 text-inherit mb-0 text-dark">IsReviewed</span>
                                        @else
                                            <span class="d-block h5 text-inherit mb-0 text-success">Completed</span>
                                        @endif
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        @if ($item->status == 'notstarted')
                                            <span class="d-block h5 text-inherit mb-0 text-warning">Not Started</span>
                                        @elseif($item->status == 'started')
                                            <span class="d-block h5 text-inherit mb-0 text-dark">Started</span>
                                        @else
                                            <span class="d-block h5 text-inherit mb-0 text-success">Completed</span>
                                        @endif
                                    </div>
...
<script>
    function getfantasytype(selectElement) {
        ...
        window.location.href = '{{ route('allmatches.view', ':encodedName') }}'.replace(':encodedName', encodedName);
    }
</script>
