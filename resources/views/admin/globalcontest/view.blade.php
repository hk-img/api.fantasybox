    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('globalcontest.create') }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('globalcontest.edit', base64_encode($item->id)) }}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        @if ($item->contest_type == 'Amount')
                                            <a href="{{ route('globalcontest.pricecard', base64_encode($item->id)) }}"
...
<script>
    function getfantasytype(selectElement) {
        ...
        window.location.href = '{{ route('globalcontest.view', ':encodedName') }}'.replace(':encodedName',
            encodedName);
    }
</script>
<script>
        ...
        swal({
            ...
            if (confirmed) {
                $.ajax({
                    ...
                    url: "{{ route('globalcontest.deleteglobalcontest') }}",
                    data: {
                        id: id
                    },
