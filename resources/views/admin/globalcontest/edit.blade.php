                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label for="teamsize" class="form-label">Team Size *<i
                                        ...
                                        <option value="1" {{ $collection->team_size == 1 ? 'selected' : '' }}>2</option>
                                        <option value="5" {{ $collection->team_size == 5 ? 'selected' : '' }}>5</option>
                                        <option value="7" {{ $collection->team_size == 7 ? 'selected' : '' }}>7</option>
                                        <option value="9" {{ $collection->team_size == 9 ? 'selected' : '' }}>9</option>
                                        <option value="11" {{ $collection->team_size == 11 ? 'selected' : '' }}>11</option>
                                    </select>
                                <!-- <input type="text" class="form-control" name="team_size" id="teamsize"
                                    placeholder="Enter Teamsize" aria-label="" value="{{ $collection->team_size }}" required> -->
                            </div>
                        </div>
                        <div class="row">
