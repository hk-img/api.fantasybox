            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Add Offer</h4>
                    </div>
                    <!-- End Header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description"
                                        placeholder="Enter Description" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="offercode" id="offercode"
                                        placeholder="Enter Offer Code" aria-label="" value="" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="bonus" id="bonus"
                                        placeholder="Enter Bonus Amount" pattern="[1-9][0-9]*" title="Amount must be greater than 0" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="minamount" id="minamount"
                                        placeholder="Enter Minimum Amount" pattern="[1-9][0-9]*" title="Amount must be greater than 0" value="" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="maxamount" id="maxamount"
                                        placeholder="Enter Maximum Amount" pattern="[1-9][0-9]*" title="Amount must be greater than 0" aria-label="" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="js-flatpickr form-control flatpickr-custom"
                                        placeholder="Select Start Date" name="start_date" required
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="js-flatpickr form-control flatpickr-custom"
                                        placeholder="Select Expire Date" name="expire_date" required
                                        data-hs-flatpickr-options='{
                                                  "dateFormat": "Y-m-d H:i",
                                                  "enableTime": true,
                                                  "minDate": "today"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="user_time" id="user_time"
                                        placeholder="Enter Max Used" aria-label="" pattern="[1-9][0-9]*" title="Max Used must be greater than 0" value="" required>
                                </div>
                            </div>
                            <!-- End Form -->
