        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Banner</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">URL</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('banner.edit', base64_encode($item->id)) }}" type="button"
                                        class="btn btn-success btn-sm">
                                        <i class="bi-pencil-fill me-1"></i> Edit
                                    </a>
                                    <a href="{{ route('banner.deletebanner', base64_encode($item->id)) }}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <a href="{{ $item->url }}" target="_blank"
                                            class="d-block h5 text-inherit mb-0">{{ $item->url }}</a>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
