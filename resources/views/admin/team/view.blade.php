        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Teams</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Team Short Name</th>
                            <th class="table-column-ps-0">Team Logo</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('team.edit', base64_encode($item->id)) }}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->short_name }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        @if (strpos($item->logo, 'https') === 0)
                                            <img class="avatar avatar-lg" src="{{ $item->logo }}" class="img-fluid"
                                                style="max-height: 50px; max-width: 50px;"
                                                onerror="this.src='{{ asset('public/settings/' . SettingsTrait::settings('team_image')) }}'">
                                        @else
                                            <img class="avatar avatar-lg" src="{{ asset('public/' . $item->logo) }}"
...
<script>
    function getfantasytype(selectElement) {
        ...
        window.location.href = '{{ route('team.view', ':encodedName') }}'.replace(':encodedName', encodedName);
    }
</script>
