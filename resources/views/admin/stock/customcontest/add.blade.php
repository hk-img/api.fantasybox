    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('match.stockcustomcontest', ['matchkey'=>$_GET['matchkey']]) }}">
                                        ...
                                        <select class="js-select form-select" id="matchkey" name="matchkey"
                                            ...
                                            @foreach ($launchedmatch as $val)
                                                <option <?php if ($_GET['matchkey'] == $val->matchkey) {
                                                    ...
                                                    data-option-template='<span class="d-flex align-items-center"><span class="flex-grow-1 ms-2">{{ $val->date }}</span></span>'>
                                                    <span class="text-dark">{{ date('l,',strtotime($val->date))}}</span><span class="text-warning">{{ date(' d-M-y',strtotime($val->date))}}</span><span class="text-success ml-2">{{ date(' h:i:s a',strtotime($val->date))}}</span></option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
