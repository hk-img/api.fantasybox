    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Commodity Manager</h1>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{route('getallcommodity')}}">
                        <i class="bi bi-cloud-download-fill"></i> Import Commodity
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Commodity</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Commodity Name</th>
                            <th class="table-column-ps-0">Symbol</th>
                            <th class="table-column-ps-0">Current Value</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->currentvalue }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
