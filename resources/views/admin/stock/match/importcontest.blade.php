        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">Select Global Contest</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <div id="datatableCounterInfo" style="display: none;">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-outline-warning btn-sm" onclick="multiselect(<?php echo $matchkey ?>)">
                                ...
                                <td class="table-column-pe-0">
                                    <div class="form-check">
                                        <input class="form-check-input" name="checkcontest" type="checkbox"
                                            value="{{ $item->id }}" id="datatableCheckAll1">
...
<script>
    function multiselect(mid) {
        var p = [];
        $.each($("input[name='checkcontest']:checked"), function() {
            p.push($(this).val());
        });
        console.log(p);
        if (p != "") {
            swal({
                title: "Are you sure?",
                text: "You want to Import Contest!",
                icon: "error",
                buttons: {
                    confirm: {
                ...
                if (confirmed) {
                    $.ajax({
                        ...
                        url: "{{ route('match.importstockmatchcontest') }}",
                        data: {
                            _token: "{{ csrf_token() }}",
                            matchkey: mid,
                            contests: p
                        ...
                        success: function(data) {
                            swal("Contest has been Imported!", {
                                icon: "success",
                            }).then(() => {
                                window.location.href = "../stockcustomcontest?matchkey="+mid;
                            });
                        },
                    ...
                    swal("Decline Import Request!");
                }
            });
        } else {
            swal('Please select atlease one contest to import');
        }
    }
</script>
