    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Exchange Manager</h1>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{route('getallstockexchange')}}">
                        <i class="bi bi-cloud-download-fill"></i> Import Exchange
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Exchanges</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Exchange Name</th>
                            <th class="table-column-ps-0">Code</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{route('getcompanylist',$item->code)}}" type="button"
                                        class="btn btn-success btn-sm text-white">
                                        <i class="bi bi-cloud-download-fill me-1"></i> Import Company
                                    </a>
                                    @if ($item->status == 1)
                                        <a href="" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->code }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->country }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
