    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('stockcategory.create') }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('stockcategory.edit', base64_encode($item->id)) }}" type="button"
                                        class="btn btn-success btn-sm">
                                        <i class="bi-pencil-fill me-1"></i> Edit
                                    </a>
                                    <a href="{{ route('stockcategory.deletecategory', base64_encode($item->id)) }}"
