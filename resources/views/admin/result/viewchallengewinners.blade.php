    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">Joined Users</h4>
                </div>
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Team</th>
                            <th class="table-column-ps-0">Email</th>
                            <th class="table-column-ps-0">Mobile</th>
                            <th class="table-column-ps-0">Transaction Id</th>
                            <th class="table-column-ps-0">Rank</th>
                            <th class="table-column-ps-0">Points</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->rank }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td>
                                    <a href="{{ route('result.viewteam', [base64_encode($item->matchkey), base64_encode($item->teamid)]) }}"
                                        type="button" class="btn btn-success btn-sm">
                                        <i class="bi bi-eye-fill me-1"></i>View Team
                                    </a>
                                </td>
                            </tr>
                            @php
