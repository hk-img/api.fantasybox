        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Series Listing</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Series Name</th>
                            <th class="table-column-ps-0">No. Of Matches</th>
                            <th class="table-column-ps-0">Winner Decleared Required</th>
                            <th class="table-column-ps-0">Start Date</th>
                            <th class="table-column-ps-0">End Date</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <a href="{{ route('result.seriesdetail', base64_encode($item->id)) }}"
                                            class="d-block h5 text-danger mb-0"
                                            style="cursor: pointer">{{ $item->name }}</a>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{DB::table('listmatches')->where('series',$item->id)->count();}}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{DB::table('listmatches')->where('series',$item->id)->where('launch_status','launched')->where('final_status','!=','IsCanceled')->count();}}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->start_date }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->end_date }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
...
<script>
    function getfantasytype(selectElement) {
        ...
        window.location.href = '{{ route('result.view', ':encodedName') }}'.replace(':encodedName', encodedName);
    }
</script>
