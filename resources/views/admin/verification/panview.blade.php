        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Pancards</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">PAN No.</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td class="table-column-pe-0">
                                    <a href="{{ route('verification.editpan', base64_encode($item->id)) }}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->pan_name }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->pan_dob }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->pan_number }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <a href="{{ asset('public/'.$item->image) }}" class="d-block h5 text-inherit mb-0 glightbox2"><img
                                            ...
                                            src="{{ asset('public/'.$item->image) }}" alt="Image Description" onerror="this.src='{{ asset('public/settings/' . SettingsTrait::settings('user_image')) }}'"
                                            ></a>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
...
<script>
    function getstatus(selectElement) {
        var url = '{{ route('verification.viewpan', ['status' => '']) }}' + selectElement;
