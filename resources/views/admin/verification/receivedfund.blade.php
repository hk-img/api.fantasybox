    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Fund Manager</h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Received Fund</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Payment Method</th>
                            <th class="table-column-ps-0">Amount</th>
                            <th class="table-column-ps-0">Order ID</th>
                            <th class="table-column-ps-0">Status</th>
                            <th class="table-column-ps-0">Date & Time</th>
                            <th class="table-column-ps-0">Return Id</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->paymentmethod }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->orderid }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->returnid }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                    @if ($item->status == 'pending')
                                <a href="{{ route('verification.approvemanualadd', base64_encode($item->id)) }}" class="btn btn-success">Success</a>
                                <a href="{{ route('verification.rejectmanualadd', base64_encode($item->id)) }}" class="btn btn-danger">Failed</a>
                                @endif
                                    </div>
                                </td>
                            </tr>
...
<script>
    function getstatus(selectElement) {
        var url = '{{ route('verification.receivedfund', ['status' => '']) }}' + selectElement;
