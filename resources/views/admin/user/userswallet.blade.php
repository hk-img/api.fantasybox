        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Users Wallet</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="table-column-ps-0">Balance</th>
                            <th class="table-column-ps-0">Winning</th>
                            <th class="table-column-ps-0">Bonus</th>
                            <th class="table-column-ps-0">Total Balance</th>
                        </tr>
                    </thead>
                    ...
                    @foreach ($collection as $item)
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->balance }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->winning }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->balance+$item->winning+$item->bonus }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
            ...
            <div style="text-align: end;border-top: dashed;padding-top: 10px;padding-right: 70px;">
                <h5>Total Balance : {{$balances->total_balance}}<span style="margin-left: 16px;">Total Winning : {{$balances->total_winning}} </span><span style="margin-left: 16px;">Total Bonus : {{$balances->total_bonus}} </span><span style="margin-left: 16px;">Total Balance : {{$balances->total_balance+$balances->total_winning+$balances->total_bonus}} </span></h5>
            </div>
            <!-- Footer -->
