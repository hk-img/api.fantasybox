    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('user.addadminwallet') }}">
                        <i class="bi bi-plus-circle-fill"></i> Credit & <i class="bi bi-dash-circle-fill"></i> Debit Amount
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Admin Wallet List</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="table-column-ps-0">Description</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->description }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
