            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Edit Influencer</h4>
                    </div>
                    <!-- End Header -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="email" id="email" placeholder=""
                                        aria-label="" value="{{$collection->email}}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder=""
                                        aria-label="" value="{{$collection->mobile}}" readonly>
                                </div>
                                <div class="col-md-6 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="refer_code" id="refer_code" placeholder=""
                                        aria-label="" value="{{$collection->refer_code}}" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="percentage" id="percentage" placeholder=""
                                        aria-label="" value="{{$collection->percentage}}" required>
                                </div>
                            </div>
                            <!-- End Form -->
