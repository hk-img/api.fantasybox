    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('influencer.create') }}">
                        <i class="bi bi-plus-lg"></i> Add Influencer
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Influencer</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="table-column-ps-0">Percentage</th>
                            <th class="table-column-ps-0">Refer Code</th>
                            <th class="table-column-ps-0">Total Earned</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($collection as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('influencer.edit', base64_encode($item->id)) }}" type="button"
                                        class="btn btn-success btn-sm">
                                        <i class="bi-pencil-fill me-1"></i> Edit
                                    </a>
                                    <a href="{{ route('influencer.deleteinfluencer', base64_encode($item->id)) }}"
                                        type="button" class="btn btn-danger btn-sm">
                                        <i class="me-1"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="#ffff" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                                <path
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->percentage }} %</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span
                                            class="d-block h5 text-inherit mb-0">{{ DB::table('influencer_bonus')->where('userid', $item->id)->sum('amount') }}</span>
                                    </div>
                                </td>
                            </tr>
                            @php
